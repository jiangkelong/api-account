...
namespace Api.Common
{
    public class Utils
    {
        public static string FormatDatetimeToStr(string str, string format = "yyyy-MM-dd")
        {
            DateTime result;
        ...
        /// <param name="str">如1,2,3,4,5</param>
        /// <returns></returns>
        public static List<decimal> StrToListDecimal(string str)
        {
